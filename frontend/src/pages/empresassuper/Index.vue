  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'maxUsers', label: 'Limite de Usuarios', field: 'maxUsers', align: 'center' },
        { name: 'maxConnections', label: 'Limite de Conexiones', field: 'maxConnections', align: 'center' },
        ...
        DeletarTenant(tenant)
          .then(res => {
            ...
            this.$q.notify({
              ...
              progress: true,
              position: 'top',
              message: `Empresa ${tenant.id} borrada!`,
              actions: [{
                icon: 'close',
                round: true,
                color: 'white'
