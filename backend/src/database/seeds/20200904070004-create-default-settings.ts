...
module.exports = {
  up: (queryInterface: QueryInterface) => {
    return queryInterface.sequelize.query(
      ...
      INSERT INTO public."Settings" ("key", value, "createdAt", "updatedAt", "tenantId", id) VALUES('callRejectMessage', 'Las llamadas de voz y video están deshabilitadas para este WhatsApp, envíe un mensaje de texto.', '2020-12-12 16:08:45.354', '2020-12-12 16:08:45.354', 1, 10);
